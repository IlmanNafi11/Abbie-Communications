...
public class Restock extends javax.swing.JInternalFrame implements UpdateTable{
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(754, 171, 90, 40));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Transaction ID", "Product Name", "Quantity", "Price", "Supplier Name", "Total", "Date"
            }
        ) {
        ...
        getContentPane().add(JScrollPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 230, 978, 735));
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Restock.png"))); // NOI18N
